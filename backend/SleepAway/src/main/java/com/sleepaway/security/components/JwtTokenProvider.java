...
public class JwtTokenProvider {
    ...
    private long validityInMilliseconds = 1800000; // 20 minutes
    ...
    public String createToken(String username, Role appUserRole) {

        Claims claims = Jwts.claims().setSubject(username);
        claims.put("auth", new SimpleGrantedAuthority(appUserRole.getAuthority()));
